"""Experiment 32 (budget search, checkpoint 1 of 2): the decisive
depth-gradient reading for gpt2 fine-tuned 20 steps on the diverse
...
MODEL_NAME = "results/finetune_ckpts/gpt2_ftdiverse_steps20"
OUTPUT_PATH = "results/atlas_nn_stage_c_real_budget_search_ftdiverse20.json"
