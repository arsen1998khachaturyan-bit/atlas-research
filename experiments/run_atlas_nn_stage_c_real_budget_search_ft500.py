"""Experiment 31 (budget search, checkpoint 3 of 3): the decisive
depth-gradient reading for gpt2 fine-tuned 500 steps -- the heaviest
...
MODEL_NAME = "results/finetune_ckpts/gpt2_ft_steps500"
OUTPUT_PATH = "results/atlas_nn_stage_c_real_budget_search_ft500.json"
