"""Experiment 32 (budget search, checkpoint 2 of 2): the decisive
depth-gradient reading for gpt2 fine-tuned 500 steps on the diverse
ten-topic corpus. See run_atlas_nn_stage_c_real_smoke_ftdiverse20.py and
experiments/run_finetune_diverse_checkpoints.py for the full rationale.
...
MODEL_NAME = "results/finetune_ckpts/gpt2_ftdiverse_steps500"
OUTPUT_PATH = "results/atlas_nn_stage_c_real_budget_search_ftdiverse500.json"
