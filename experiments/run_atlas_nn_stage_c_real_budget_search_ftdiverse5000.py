"""Experiment 33 (budget search): the decisive depth-gradient reading
for gpt2 fine-tuned 5000 steps on the diverse ten-topic corpus -- 10x
Experiment 32's maximum, testing the non-monotonic fine-tuning-intensity
hypothesis. See run_atlas_nn_stage_c_real_smoke_ftdiverse5000.py and
experiments/run_finetune_diverse_large_checkpoints.py for the full
rationale.
...
MODEL_NAME = "results/finetune_ckpts/gpt2_ftdiverse_steps5000"
OUTPUT_PATH = "results/atlas_nn_stage_c_real_budget_search_ftdiverse5000.json"
