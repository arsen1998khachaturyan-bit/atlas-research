"""Experiment 31 (budget search, checkpoint 2 of 3): the decisive
depth-gradient reading for gpt2 fine-tuned 100 steps -- the middle
...
MODEL_NAME = "results/finetune_ckpts/gpt2_ft_steps100"
OUTPUT_PATH = "results/atlas_nn_stage_c_real_budget_search_ft100.json"
